...
contract Vester is BaseToken, ReentrancyGuard {
    ...
    constructor(
        ...
        esToken = _esToken; // esToken
        pairToken = _pairToken; // sToken
        claimableToken = _claimableToken; // TOKEN
    }
